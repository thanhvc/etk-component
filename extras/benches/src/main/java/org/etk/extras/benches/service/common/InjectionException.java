...
public class InjectionException extends RuntimeException {
   ...
   */
  public InjectionException(final String msgKey) {
    super();
    messageKey = msgKey;
  }
   ...
   */
  public InjectionException(final String msgKey, final String[] msgArgs) {
    super();
    messageKey = msgKey;
   ...
   */
  public InjectionException(final String msgKey, final String msg) {
    super(msg);
    messageKey = msgKey;
  }
