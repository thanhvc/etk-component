...
/**
 * @param <V> {@link org.exoplatform.services.rest.RequestFilter} or
 *          {@link org.exoplatform.services.rest.ResponseFilter}
 */
public class UriPatternMap<V> extends HashMap<UriPattern, List<V>> implements
    ExtMultivaluedMap<UriPattern, V> {
