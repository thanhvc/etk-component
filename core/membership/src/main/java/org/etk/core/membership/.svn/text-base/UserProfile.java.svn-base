...
public interface UserProfile {
   ...
   */
  final static public String[] PERSONAL_INFO_KEYS = { "user.name.given", "user.name.family",
      "user.name.nickName", "user.bdate", "user.gender", "user.employer", "user.department",
      "user.jobtitle", "user.language",          };

  /**
   * The predefine attributes of the user home info. Those attributes are define
   * in the JSR 168 specification
   */
  final static public String[] HOME_INFO_KEYS     = { "user.home-info.postal.name",
      "user.home-info.postal.street", "user.home-info.postal.city",
      "user.home-info.postal.stateprov", "user.home-info.postal.postalcode",
      "user.home-info.postal.country", "user.home-info.telecom.mobile.number",
      "user.home-info.telecom.telephone.number", "user.home-info.online.email",
   ...
   * define in the JSR 168 specification
   */
  final static public String[] BUSINESE_INFO_KEYS = { "user.business-info.postal.name",
      "user.business-info.postal.city", "user.business-info.postal.stateprov",
   ...
   * in the exo forum
   */
  final static public String[] OTHER_KEYS         = { "user.other-info.avatar.url",
      "user.other-info.signature",               };
