...
import org.etk.core.membership.impl.MembershipImpl;
 ...
 * @version $Id: DummyOrganizationService.java 34415 2009-07-23 14:33:34Z
 *          dkatayev $
 */
  ...
  public static class GroupHandlerImpl implements GroupHandler {
    ...
    public Collection findGroups(Group parent) throws Exception {
      if (parent.getId().equals(GROUPID_PLATFORM)) {
        ...
        groups.add(new DummyGroup(GROUPID_PLATFORM,
                                  GROUPID_ADMINISTRATORS,
                                  GROUPNAME_ADMINISTRATORS));
        return groups;
      }
